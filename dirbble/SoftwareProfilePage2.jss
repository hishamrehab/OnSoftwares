      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            />
            <div className="ml-4">
              <h1 className="text-2xl font-bold text-gray-900">CloudPulse</h1>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">About CloudPulse</h3>
              <p className="text-gray-400 text-sm">
                Enterprise-grade cloud infrastructure monitoring and management
                platform with blockchain verification.
              </p>
            </div>
            <div>
