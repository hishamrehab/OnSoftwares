      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold text-indigo-600">OnSoftwares</div>
            <nav className="hidden md:flex space-x-8">
              <a href="#" className="text-gray-700 hover:text-indigo-600">Home</a>
              <a href="#" className="text-indigo-600 font-medium">Marketplace</a>
              <a href="#" className="text-gray-700 hover:text-indigo-600">Certification</a>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors !rounded-button whitespace-nowrap cursor-pointer">
                Sign In
              </button>
            </div>
          </div>
